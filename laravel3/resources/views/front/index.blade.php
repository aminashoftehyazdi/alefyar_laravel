...
<html lang="en">
	<head>
		...
		<link href="{{ url('front/assets/css/app.css' )}}" rel="stylesheet">
		<!-- =======================================================
			...
			<div class="container d-flex h-100">
				<div class="row justify-content-center align-self-center" data-aos="fade-up">
					...
					<div class="col-md-6 intro-img order-md-last order-first" data-aos="zoom-out" data-aos-delay="200">
						<img src="front/assets/img/intro-img.svg" alt="" class="img-fluid">
					</div>
				</div>
			</div>
		</section><!-- End Hero -->
				...
				<div class="row">
					<div class="col-lg-6" data-aos="zoom-in" data-aos-delay="100">
						<div class="why-us-img">
							<img src="front/assets/img/why-us.jpg" alt="" class="img-fluid">
						</div>
					</div>
					<div class="col-lg-6">
			...
			<div class="container" data-aos="fade-up">
				<div class="row feature-item">
					<div class="col-lg-6" data-aos="fade-right" data-aos-delay="100">
						<img src="front/assets/img/features-1.svg" class="img-fluid" alt="">
					</div>
				...
				<div class="row feature-item mt-5 pt-5">
					<div class="col-lg-6 wow fadeInUp order-1 order-lg-2" data-aos="fade-left" data-aos-delay="100">
						<img src="front/assets/img/features-2.svg" class="img-fluid" alt="">
					</div>
		...
		<section id="clients" class="clients">
			<div class="container" data-aos="zoom-in">
				...
				<div class="owl-carousel clients-carousel">
					<img src="front/assets/img/clients/client-1.png" alt="">
					<img src="front/assets/img/clients/client-2.png" alt="">
					<img src="front/assets/img/clients/client-3.png" alt="">
					<img src="front/assets/img/clients/client-4.png" alt="">
					<img src="front/assets/img/clients/client-5.png" alt="">
					<img src="front/assets/img/clients/client-6.png" alt="">
					<img src="front/assets/img/clients/client-7.png" alt="">
